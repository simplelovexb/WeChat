...
public class RequestMsgDao extends AbstractDao<RequestMsg, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Contactheadbig = new Property(8, String.class, "contactheadbig", false, "CONTACTHEADBIG");
        public final static Property Contactheadmid = new Property(9, String.class, "contactheadmid", false, "CONTACTHEADMID");
        public final static Property Contactheadsmall = new Property(10, String.class, "contactheadsmall", false, "CONTACTHEADSMALL");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'REQUEST_MSG' (" + //
                ...
                "'CONTACTHEADBIG' TEXT," + // 8: contactheadbig
                "'CONTACTHEADMID' TEXT," + // 9: contactheadmid
                "'CONTACTHEADSMALL' TEXT," + // 10: contactheadsmall
    ...
    protected void bindValues(SQLiteStatement stmt, RequestMsg entity) {
        ...
        if (contactheadbig != null) {
            stmt.bindString(9, contactheadbig);
        }
        ...
        if (contactheadsmall != null) {
            stmt.bindString(11, contactheadsmall);
        }
    ...
    public RequestMsg readEntity(Cursor cursor, int offset) {
        RequestMsg entity = new RequestMsg( //
            ...
            cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8), // contactheadbig
            cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9), // contactheadmid
            cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10), // contactheadsmall
    ...
    public void readEntity(Cursor cursor, RequestMsg entity, int offset) {
        ...
        entity.setContactheadbig(cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8));
        entity.setContactheadmid(cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9));
        entity.setContactheadsmall(cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10));
